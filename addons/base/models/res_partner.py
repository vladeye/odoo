...
class Partner(models.Model):
    ...
    test_name = fields.Char(string='Name', store=True)
    test_phone = fields.Char(string='Phone', store=True)
    test_desc = fields.Text(string='Comments', store=True)
    ...
    job_type = fields.Selection(
        ...
        default='',
        help="Custom field.")
    exp_comp1 = fields.Char(string='Company 1', store=True)
    exp_comp2 = fields.Char(string='Company 2', store=True)
    exp_comp3 = fields.Char(string='Company 3', store=True)
    exp_comp4 = fields.Char(string='Company 4', store=True)
